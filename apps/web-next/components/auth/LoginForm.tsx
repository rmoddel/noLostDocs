    ...
    <section className="page-section">
      <Card className="content-card compact-card">
        ...
        <p className="section-copy">
          The Next app now wires the real magic-link entry point. Signed-out users who open protected routes are returned here first.
        </p>
        ...
        <p className="support-copy">
          {configured ? "Login is wired to Supabase publishable credentials." : "Add NEXT_PUBLIC Supabase values to activate login."}
        </p>
