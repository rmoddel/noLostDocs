...
export function ProductMockup() {
  return (
    <section className="section-block">
      <SectionHeader
        description="The web portal should feel clear before it feels complex. Categories lead, files stay protected, and account state stays visible."
        eyebrow="Portal preview"
        title="A calmer dashboard foundation."
      />
      <div className="mockup-grid">
        ...
        <div className="mockup-copy">
          <p className="eyebrow">What the portal needs to communicate</p>
