  ...
  return (
    <section className="section-block">
      <div className="split-section">
        <div>
          <SectionHeader
            description="Cloud-backed documents can be recovered through the web experience. Local-only documents remain only on the original device."
            eyebrow="Lost your phone?"
            title="Lock your account and stop access until the device is re-authorized."
          />
        </div>
        <Card className="recovery-card">
          ...
          <div className="recovery-step">
            ...
            <div>
              <strong>Recover from the web</strong>
